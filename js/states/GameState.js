var GameState = {
    preload:function(){//Cargamos el json de la configuracion de los animales
        ...
        this.load.audio('bear','assets/audio/bear.ogg');
        ...
        this.load.audio('crocodile','assets/audio/crocodile.ogg');
        this.load.audio('lion','assets/audio/lion.ogg');
        this.load.audio('monkey','assets/audio/monkey.ogg');
        this.load.audio('panda','assets/audio/panda.ogg');
        this.load.audio('parrot','assets/audio/parrot.ogg');
        this.load.audio('penguin','assets/audio/penguin.ogg');
        this.load.audio('polar_bear','assets/audio/polar_bear.ogg');
        this.load.audio('rhinoceros','assets/audio/rhinoceros.ogg');
        this.load.audio('seal','assets/audio/seal.ogg');
        this.load.audio('snake','assets/audio/snake.ogg');
